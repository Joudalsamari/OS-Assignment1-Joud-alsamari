...
public class SchedulerSimulation {
    public static void main(String[] args) {
        ...
        int studentID = 445052056; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            // Feature 1: Generate a random priority value between 1 and 5
        ...
        while (!processQueue.isEmpty()) {
            ...
            for (Thread thread : processQueue) {
                ...
                System.out.print(
                        Colors.BRIGHT_CYAN + process.getName() + "(Pri:" + process.getPriority() + ")" + Colors.RESET);
                queueCount++;
            }
            if (queueCount == 0) {
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,
        ...
        System.out.println(Colors.BLUE + "  ➕ " + Colors.BOLD + Colors.CYAN + process.getName() +
                Colors.RESET + Colors.BLUE + " (Pri:" + process.getPriority() + " ) added to ready queue" + Colors.RESET
                +
