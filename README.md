...
```
Student Name: [Joud Ali Alsamari]
Student ID: [445052056]
GitHub Username: [Joudalsamari]
Repository Link:(https://github.com/Joudalsamari/OS-Assignment1-Joud-alsamari.git)
Video Link: [Google Drive link - make sure it's accessible to anyone with the link]
Date Submitted: [28 march , 2026]
```
